  ...
  final List<Map<String, dynamic>> fonts = [
    {
      'name': 'MaterialIcons',
      'files': [
        'packages/influxui_test/fonts/MaterialIcons-Regular.otf',
      ],
    },
    {
      'name': 'Roboto',
      'files': [
        'packages/influxui_test/fonts/Roboto-Regular.ttf',
      ],
    },
    {
      'name': 'Roboto Mono',
      'files': [
        'packages/influxui_test/fonts/RobotoMono-Regular.ttf',
      ],
    },
  ];
