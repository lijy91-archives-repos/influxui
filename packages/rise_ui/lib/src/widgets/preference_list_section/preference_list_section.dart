...
enum PreferenceListSectionType {
  /// A basic form of [PreferenceListSection].
  base,

  /// An inset-grouped style of [PreferenceListSection].
  insetGrouped,
}

/// An iOS-style list section.
///
/// The [PreferenceListSection] is a container for children widgets. These are
/// most often [PreferenceListTile]s.
///
/// The base constructor for [PreferenceListSection] constructs an
...
///
/// The [PreferenceListSection.insetGrouped] constructor creates a round-edged
...
/// Typically, the children are of type [PreferenceListTile], however these is
/// not enforced.
///
...
/// [PreferenceListSection.insetGrouped]. Defaults to zero radius for the
...
///
/// {@tool dartpad}
/// Creates a base [PreferenceListSection] containing [PreferenceListTile]s with
...
///
/// {@tool dartpad}
/// Creates an "Inset Grouped" [PreferenceListSection] containing
/// notched [PreferenceListTile]s with `leading`, `title`, `additionalInfo` and
/// `trailing` widgets.
///
...
/// See also:
///
///  * [PreferenceListTile], an iOS-style list tile, a typical child of
...
class PreferenceListSection extends StatelessWidget {
  ...
  /// [PreferenceListTile], but it can be overwritten for custom look.
  ///
  /// The [hasLeading] parameter specifies whether children [PreferenceListTile]
  ...
  /// the section. The [children] parameter takes a list, as opposed to a more
  /// efficient builder function that lazy builds, because forms are intended to
  /// be short in row count. It is recommended that only [PreferenceListTile]
  ...
  const PreferenceListSection.insetGrouped({
    ...
    this.separatorColor,
        ...
        type = PreferenceListSectionType.insetGrouped,
        additionalDividerMargin = additionalDividerMargin ??
            (hasLeading
  ...
  /// [PreferenceListSection] constructor. Defaults to the standard notched-style
  /// iOS margin when constructing with [PreferenceListSection.insetGrouped].
  final EdgeInsetsGeometry margin;

  /// The list of rows in the section. Usually a list of [PreferenceListTile]s.
  ///
  ...
  /// It is recommended that only [PreferenceListTile] widget be included in the
  ...
  /// with [PreferenceListSection.insetGrouped]. Defaults to zero radius for the
  /// standard [PreferenceListSection] constructor.
  ...
  Widget build(BuildContext context) {
    ...
    // Only used in PreferenceListSectionType.base mode.
    ...
    if (children != null && children!.isNotEmpty) {
      ...
      // If it is a `PreferenceListSectionType.base` type, add a long divider
      ...
      final BorderRadius childrenGroupBorderRadius = switch (type) {
        PreferenceListSectionType.insetGrouped =>
          _kDefaultInsetGroupedBorderRadius,
        PreferenceListSectionType.base => BorderRadius.zero,
      };
        ...
        children: <Widget>[
          ...
          if (headerWidget != null)
            Align(
              ...
              child: Padding(
                padding: type == PreferenceListSectionType.base
