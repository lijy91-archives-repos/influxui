  ...
  group('badge-goldens', () {
    ...
    testGolden(
      ...
      (_) => Row(
        ...
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          Badge(label: 'Badge', shape: Shape.rectangle),
          Badge(label: 'Badge', shape: Shape.square),
          Badge(label: 'Badge', shape: Shape.circle),
          Badge(label: 'Badge', shape: Shape.round),
          Badge(label: 'Badge', shape: Shape.pill),
        ],
      ),
      size: Size(400, 60),
    );
